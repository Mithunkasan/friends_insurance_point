...
const translateFaq = (faq: any, lang: string) => {
  ...
  const mapping: Record<string, { q: string; a: string }> = {
    ...
    'How do I file an insurance claim in case of an accident?': {
      ...
      a: 'விபத்து ஏற்பட்டால் உடனடியாக எங்களை 7598657990 என்ற எண்ணில் தொடர்பு கொள்ளுங்கள். நாங்கள் உங்களுக்கு வழிகாட்டி, கேஷ்லெஸ் பழுதுபார்ப்பிற்கான நெட்வொர்க் கேரேஜை கண்டறிந்து, காப்பீட்டு நிறுவனத்தில் கிளைம் செய்ய தேவையான அனைத்து உதவிகளையும் செய்வோம்.'
    },
